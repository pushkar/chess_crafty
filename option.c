 ...
 */
   ...
   ************************************************************
   *                                                          *
   *   "pipe" command uses pipes for I/O.		              *
   *   Waits for client to start off and then starts taking   *
   *   input from the default pipe INPUT_PIPE and redirects   *
   *   output to OUTPUT_PIPE                                  *
   *                                                          *
   ************************************************************
   */
